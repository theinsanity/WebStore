...
/****** Object:  Database [Repository]    Script Date: 07-Jun-17 2:03:43 AM ******/
CREATE DATABASE [Repository]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Repository', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\Repository.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Repository_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\Repository_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Repository] SET COMPATIBILITY_LEVEL = 130
GO
